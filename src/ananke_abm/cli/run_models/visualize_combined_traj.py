...
@option("-y_work_max", "--y_work_max", type=float, default=0.5)
@option("-y_edu_max", "--y_edu_max", type=float, default=0.5)
@option("-dpi", "--dpi", type=int, default=300)
def visualize_combined_traj(traj_csv, buffer_csv, out_dir, y_work_max, y_edu_max, dpi):
    ...
    fig_primary_lunch_time(buffer_csv, out_dir if out_dir else None, y_work_max, y_edu_max, 600, 840, dpi)