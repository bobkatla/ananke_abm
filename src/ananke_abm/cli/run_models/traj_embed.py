...
def traj_embed(activities_csv, purposes_csv, epochs, batch_size, lr, val_ratio, outdir, device):
    """Train the TrajEmbed model."""
    train_traj_embed(activities_csv, purposes_csv, epochs, batch_size, lr, val_ratio, outdir, device)