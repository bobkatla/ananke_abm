...
def evaluate():
    ...
    for i, person_id in enumerate(person_ids):
        ...
        ax1.plot(plot_times, pred_locations[i], '-', label='Generated Location (Batched)')
        ...
        ax2.plot(plot_times, pred_purposes[i], '-', label='Generated Purpose (Batched)')
        ...
        ax3.plot(plot_times, pred_modes[i], '-', label='Generated Mode (Batched)')
