...
uv run rgen_schedule sample-population \
  ...
  --num-samples 42817 \
  --outprefix src/output/new_rgen/runs/pmd_crf_nonhome/pmd_crf_nonhome \
  --decode-mode crf \
...
uv run rgen_schedule eval-population \
  --samples src/output/new_rgen/runs/pmd_crf_nonhome/pmd_crf_nonhome.npz \
  --samples-meta src/output/new_rgen/runs/pmd_crf_nonhome/pmd_crf_nonhome_meta.json \
